...
namespace cdes_presets
{
    public class UIButton : UdonSharpBehaviour
    {
        ...
        [SerializeField] public int ButtonID = -1;
        ...
        public void _ResetPosition()
        {
            ...
            float depth = this.transform.Find("Visual/Button").GetComponent<SkinnedMeshRenderer>().sharedMesh.bounds.size.y * 0.9f;
            ...
            else if (canClick)
            {
                if (buttonState == STATE_DEPRESSED)
                {
                    ...
                    else if (buttonType == BUTTON_ONETIME)
                    {
                        ...
                        button.GetComponent<SkinnedMeshRenderer>().material.mainTexture = buttonOn;
                    ...
                    else if (buttonType == BUTTON_TOGGLE)
                    {
                        ...
                        button.GetComponent<SkinnedMeshRenderer>().material.mainTexture = toggleState ? buttonOn : buttonOff;
        ...
        {
            Vector3 size = button.GetComponent<SkinnedMeshRenderer>().sharedMesh.bounds.size;
        ...
        public void _ResetPushButton()
        {
            ...
            buttonState = STATE_INACTIVE;
            button.GetComponent<SkinnedMeshRenderer>().material.mainTexture = buttonOff;
            visual.transform.localPosition = unpressedPosition;
        }
